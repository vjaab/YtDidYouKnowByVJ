...
PHONETIC_DICT = {
    ...
    "Geminis": "Jem-in-eyes",
    "Perplexity": "Per-plex-ih-tee",
    "Mistral": "Miss-trahl",
    "Mixtral": "Mix-trahl",
    "Inflection": "In-flek-shun",
    "Cohere": "Co-heer",
    "Voyage": "Voy-ahzh",
    "DeciAI": "Dess-ee A-I",
    "Cerebras": "Seh-ree-bras",
    ...
    "Copilot": "koh-py-lut",
    "GitHub Copilot": "Git-hub koh-py-lut",
    ...
    "GroundSource's": "Ground-Source's",
    "Meta": "Meh-tah",
    "Llama": "Lah-mah",
    "Llama-3": "Lah-mah-three",
    "Llama-2": "Lah-mah-two",
    "Phi": "Fy",
    "Phi-3": "Fy-three",
    "Gemma": "Jem-mah",
    "Liquid AI": "Lik-wid A-I",
    "Neuro-symbolic": "Noor-oh sim-bol-ik",
    "BiOptimized": "By-Op-tih-mized",
    "Hugging": "Hug-ging",
    ...
    "deterministic": "De-ter-mi-nis-tik",
    ...
    "writer": "rye-ter",
    "paralegal": "pair-uh-lee-gul",
    "compliance": "kum-ply-ents",
    "officer": "o-fiss-er",
    "market": "mar-ket",
    "analyst": "ann-uh-list",
    "analysts": "ann-uh-lists",
    ...
    "parallesim": "pair-uh-lel-iz-um",
    "paralllesim": "pair-uh-lel-iz-um",
    ...
    "revolutionary": "Rev-uh-loo-shon-ary",
    ...
    "probabilistic": "Prob-ah-ba-lis-tik",
    "Synthetic": "Sin-thet-ick",
    ...
    "replacement": "ree-playce-ment",
    "operator": "aw-per-ay-ter",
    "intelligence": "In-tel-ih-junts",
    "artificial": "Ar-tih-fish-ul",
    "knowledge": "Nol-ij",
    ...
    "implementation": "Im-pluh-men-tashun",
    "implementations": "Im-pluh-men-tashuns",
