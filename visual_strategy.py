...
STORYTELLING_PATTERNS = {
    "problem_solution": {
        ...
        "slides": [
            ...
            ("technical", ["architecture_diagram", "process_flow", "layered_stack", "input_output"]),
            ("example", ["real_world_scenario", "metrics_cards", "analogy"]),
            ("comparison", ["common_mistake", "before_after"]),
            ("cta", ["takeaway"]),
        ],
    },
    "comparison_deep_dive": {
        "description": "Hook → Compare A vs B → Use cases → Trade-offs → Quiz",
        ...
        "slides": [
            ...
            ("tradeoffs", ["input_output", "metrics_cards", "before_after"]),
            ("quiz", ["quiz_choice"]),
            ("cta", ["takeaway"]),
        ],
    },
    ...
    "concept_explained": {
        ...
        "slides": [
            ...
            ("technical", ["process_flow", "architecture_diagram", "input_output"]),
    ...
    "news_breakdown": {
        ...
        "slides": [
            ...
            ("example", ["real_world_scenario", "metrics_cards"]),
            ("cta", ["takeaway"]),
        ],
    },
    "tutorial_flow": {
        "description": "Hook → Prerequisites → Steps → Mechanics → Output → Takeaway",
        "suitable_for": ["programming", "devops", "cloud"],
        "slides": [
            ("hook", ["hero_hook", "scenario_question"]),
            ("explanation", ["checklist", "bullet_list"]),
            ("technical", ["process_flow"]),
            ("execution", ["input_output"]),
            ("comparison", ["common_mistake", "before_after"]),
            ("cta", ["takeaway"]),
        ],
    },
